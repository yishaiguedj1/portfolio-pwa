/* בדיקות פריסה ועיצוב ל־v36: סרגל לשוניות שלא נחתך בקצוות, כותרת לא צפופה,
...
// v133: צבעי העוגה כבר לא עוקבים אחרי ערכת הנושא — צבע מותג קבוע, במכוון
// (ראה tests/pf-v133.test.js לבדיקות המלאות על הפלטה/הסידור/הלוגואים)
ok(/function pieColorFor/.test(appSrc), 'pieColorFor() קיים — צבע מותג קבוע לכל חברה');
...
/* ---------- התאמת גודל מספרים אוטומטית (v36) ---------- */
